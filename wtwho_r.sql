...
CREATE TABLE IF NOT EXISTS `result` (
  ...
  `5t` int(10) unsigned NOT NULL DEFAULT 0,
  `6t` int(10) unsigned NOT NULL DEFAULT 0,
  `7t` int(10) unsigned NOT NULL DEFAULT 0,
  `8t` int(10) unsigned NOT NULL DEFAULT 0,
  `9t` int(10) unsigned NOT NULL DEFAULT 0,
  `10t` int(10) unsigned NOT NULL DEFAULT 0,
  `11t` int(10) unsigned NOT NULL DEFAULT 0,
  `12t` int(10) unsigned NOT NULL DEFAULT 0,
  `13t` int(10) unsigned NOT NULL DEFAULT 0,
  `14t` int(10) unsigned NOT NULL DEFAULT 0,
  `15t` int(10) unsigned NOT NULL DEFAULT 0,
  `16t` int(10) unsigned NOT NULL DEFAULT 0,
  `17t` int(10) unsigned NOT NULL DEFAULT 0,
  `18t` int(10) unsigned NOT NULL DEFAULT 0,
  `19t` int(10) unsigned NOT NULL DEFAULT 0,
  `20t` int(10) unsigned NOT NULL DEFAULT 0,
  `21t` int(10) unsigned NOT NULL DEFAULT 0,
  `22t` int(10) unsigned NOT NULL DEFAULT 0,
  `23t` int(10) unsigned NOT NULL DEFAULT 0,
  `0t` int(10) unsigned NOT NULL DEFAULT 0,
  `1t` int(10) unsigned NOT NULL DEFAULT 0,
  `2t` int(10) unsigned NOT NULL DEFAULT 0,
  `3t` int(10) unsigned NOT NULL DEFAULT 0,
  `4t` int(10) unsigned NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
